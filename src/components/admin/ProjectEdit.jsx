...
export default function ProjectEdit({ id }) {
  ...
  const [mediaPickerGalleryIndex, setMediaPickerGalleryIndex] = useState(null); // Para gestionar URLs de galería
  ...
  const handleSubmit = async (e) => {
    ...
    const projectData = {
      ...formData,
      media: mediaItems,
      headerImg: formData.headerImg || formData.thumb,
    ...
    <main class="main-content">
      <div class="content-header">
        ...
        <div class="header-actions">
          <button type="submit" form="project-edit-form" class="btn-primary">
          ...
          <a href={`/portfolio/${formData.slug || id}`} target="_blank" rel="noopener noreferrer" class="btn-secondary">
      ...
      <form id="project-edit-form" onSubmit={handleSubmit} class="project-form">
          ...
          <div class="form-group">
            ...
            {formData.thumb && (
              <div class="image-preview">
                <img src={formData.thumb} alt="Vista previa thumbnail" loading="lazy" />
              </div>
            )}
        ...
        <div class="form-section">
          ...
          <div class="form-group">
            <label for="innerTitle">Título interior</label>
            <input
              type="text"
              id="innerTitle"
              name="innerTitle"
              ...
              onInput={handleChange}
            />
            <small>Título que se muestra en el interior del proyecto. Si se deja vacío, se usará el título principal.</small>
          </div>
